...
import { ThirdFloorContainer, ThirdFloorContainerBottom, ThirdFloorContainerTop, ThirdFloorWrapper } from './style';
const ThirdFloor = () => {
    return (    <>
                    <Container>
                        <ThirdFloorWrapper>
                            ...
                            <ThirdFloorContainer>
                                ...
                                <ThirdFloorContainerBottom>
                                    ...
                                    <MainProductCard title="Home appliance" price='39' img={appliance}/>
                                    <MainProductCard title="Coffee maker" price='10' img={tree}/>
                                </ThirdFloorContainerBottom>
                            </ThirdFloorContainer>
                        </ThirdFloorWrapper>
                    </Container>
